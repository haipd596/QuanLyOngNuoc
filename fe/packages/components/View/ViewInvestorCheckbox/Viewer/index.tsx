                  ...
                  {(values:any) => {
                    ...
                    return (
                      <>
                        ...
                        {showToChuc && type === 'ToChuc' && <Org field={field} _curServerKey={_curServerKey} index={index}/>}
                        {!showToChuc && showCaNhan && !type && <Individual index={index} />}
                        {!showCaNhan && showToChuc && !type && <Org field={field} _curServerKey={_curServerKey} index={index}/>}
                      </>
                    )
                  }}
                </Form.Item>
